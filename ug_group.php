...
$nonAdminTablesArr[] = "distritos";
$nonAdminTablesArr[] = "sectores";
$nonAdminTablesArr[] = "urna";
$nonAdminTablesArr[] = "voto_alcalde";
$nonAdminTablesArr[] = "voto_diputado";
$nonAdminTablesArr[] = "voto_presidente";
$nonAdminTablesArr[] = "usuario";
$nonAdminTablesArr[] = "Alcalde_Chart";
$nonAdminTablesArr[] = "Presidente_Chart";
$nonAdminTablesArr[] = "Pres - Por Distrito";
$nonAdminTablesArr[] = "Pres - Por Sector";
$nonAdminTablesArr[] = "Pres - Por Urna";
$nonAdminTablesArr[] = "Alc - Por Distrito";
$nonAdminTablesArr[] = "Alc - Por Sector";
$nonAdminTablesArr[] = "Alc - Por Urna";
$nonAdminTablesArr[] = "corporacion";
$nonAdminTablesArr[] = "candidatos";
$nonAdminTablesArr[] = "Dip - Por Orden";
$nonAdminTablesArr[] = "Dip - Resultado Final";
$nonAdminTablesArr[] = "Dashboard";
$nonAdminTablesArr[] = "Urnas - Pendientes";
$nonAdminTablesArr[] = "Urnas - Completadas";
...
$wGroupTableName = $ug_connection->addTableWrappers( "generales_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "generales_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "generales_ugrights" );
