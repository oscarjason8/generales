...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("alcalde_chart_chart","xt_showchart",
			array(
				"chartName"=>"alcalde_chart",
				"table"=>"Alcalde_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("presidente_chart_chart","xt_showchart",
			array(
				"chartName"=>"presidente_chart",
