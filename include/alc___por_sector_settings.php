...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsalc___por_sector["Spanish"]["Maria"] = "Maria Luisa Martell";
	$fieldToolTipsalc___por_sector["Spanish"]["Maria"] = "";
	$placeHoldersalc___por_sector["Spanish"]["Maria"] = "";
	$fieldLabelsalc___por_sector["Spanish"]["Adolfo"] = "Adolfo Canales";
	$fieldToolTipsalc___por_sector["Spanish"]["Adolfo"] = "";
	$placeHoldersalc___por_sector["Spanish"]["Adolfo"] = "";
	$fieldLabelsalc___por_sector["Spanish"]["Victor"] = "Victor Rivera";
	$fieldToolTipsalc___por_sector["Spanish"]["Victor"] = "";
	$placeHoldersalc___por_sector["Spanish"]["Victor"] = "";
...
$tdataalc___por_sector[".googleLikeFields"][] = "Maria";
$tdataalc___por_sector[".googleLikeFields"][] = "Victor";
$tdataalc___por_sector[".googleLikeFields"][] = "Adolfo";
...
$tdataalc___por_sector[".printerPageOrientation"] = 0;
...
$tdataalc___por_sector[".sqlHead"] = "select ur.id_distrito, ur.id_sector,  (select concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Maria,  (select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Victor,  (select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Adolfo,  (select sum(a.validos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Validos,  (select sum(a.blancos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Blancos,  (select sum(a.nulos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Nulos,  (select sum(a.utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Utilizados,  (select sum(a.no_utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as No_Utilizados,  (select sum(a.total) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector) as Total";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "";
	$fdata["Label"] = GetFieldLabel("Alc___Por_Sector","Maria");
	$fdata["FieldType"] = 200;
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//end of Filters settings
	...
	$tdataalc___por_sector["Maria"] = $fdata;
		$tdataalc___por_sector[".searchableFields"][] = "Maria";
//	Victor
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 4;
	...
	$fdata["ownerTable"] = "";
	$fdata["Label"] = GetFieldLabel("Alc___Por_Sector","Victor");
	$fdata["FieldType"] = 200;
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//end of Filters settings
	...
	$tdataalc___por_sector["Victor"] = $fdata;
		$tdataalc___por_sector[".searchableFields"][] = "Victor";
//	Adolfo
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 5;
	...
	$fdata["ownerTable"] = "";
	$fdata["Label"] = GetFieldLabel("Alc___Por_Sector","Adolfo");
	$fdata["FieldType"] = 200;
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//end of Filters settings
	...
	$tdataalc___por_sector["Adolfo"] = $fdata;
		$tdataalc___por_sector[".searchableFields"][] = "Adolfo";
//	Validos
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 6;
...
$proto11["m_strFieldList"] = "concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto17["m_sql"] = "concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto10["m_sql"] = "(select concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
$proto10["m_srcTableName"] = "Alc - Por Sector";
$proto10["m_expr"]=$obj;
$proto10["m_alias"] = "Maria";
...
$proto32["m_strFieldList"] = "concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto38["m_sql"] = "concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto31["m_sql"] = "(select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
$proto31["m_srcTableName"] = "Alc - Por Sector";
$proto31["m_expr"]=$obj;
$proto31["m_alias"] = "Victor";
...
$proto53["m_strFieldList"] = "concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto59["m_sql"] = "concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto52["m_sql"] = "(select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
$proto52["m_srcTableName"] = "Alc - Por Sector";
$proto52["m_expr"]=$obj;
$proto52["m_alias"] = "Adolfo";
...
$proto74["m_strFieldList"] = "sum(a.validos)";
...
$proto83["m_link"] = "SQLL_MAIN";
			$proto84=array();
$proto84["m_strName"] = "voto_alcalde";
$proto84["m_srcTableName"] = "Alc - Por Sector";
...
$proto83["m_table"] = $obj;
$proto83["m_sql"] = "voto_alcalde as a";
$proto83["m_alias"] = "a";
$proto83["m_srcTableName"] = "Alc - Por Sector";
$proto85=array();
$proto85["m_sql"] = "";
...
$proto88["m_srcTableName"] = "Alc - Por Sector";
...
$proto87["m_table"] = $obj;
$proto87["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto87["m_alias"] = "u";
$proto87["m_srcTableName"] = "Alc - Por Sector";
$proto89=array();
$proto89["m_sql"] = "a.id_urna = u.id_urna";
...
$proto73["m_sql"] = "(select sum(a.validos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto92["m_strFieldList"] = "sum(a.blancos)";
$proto92["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto98["m_sql"] = "sum(a.blancos)";
$proto98["m_srcTableName"] = "Alc - Por Sector";
$proto98["m_expr"]=$obj;
$proto98["m_alias"] = "";
...
$proto101["m_link"] = "SQLL_MAIN";
			$proto102=array();
$proto102["m_strName"] = "voto_alcalde";
$proto102["m_srcTableName"] = "Alc - Por Sector";
...
$proto101["m_sql"] = "voto_alcalde as a";
$proto101["m_alias"] = "a";
...
$proto106["m_srcTableName"] = "Alc - Por Sector";
...
$proto105["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto105["m_alias"] = "u";
$proto105["m_srcTableName"] = "Alc - Por Sector";
$proto107=array();
$proto107["m_sql"] = "a.id_urna = u.id_urna";
...
$proto92["m_srcTableName"]="Alc - Por Sector";		
$obj = new SQLQuery($proto92);

$proto91["m_sql"] = "(select sum(a.blancos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto110["m_strFieldList"] = "sum(a.nulos)";
$proto110["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto119["m_link"] = "SQLL_MAIN";
			$proto120=array();
$proto120["m_strName"] = "voto_alcalde";
$proto120["m_srcTableName"] = "Alc - Por Sector";
...
$proto119["m_sql"] = "voto_alcalde as a";
$proto119["m_alias"] = "a";
$proto119["m_srcTableName"] = "Alc - Por Sector";
$proto121=array();
$proto121["m_sql"] = "";
...
$proto124["m_srcTableName"] = "Alc - Por Sector";
...
$proto123["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto123["m_alias"] = "u";
$proto123["m_srcTableName"] = "Alc - Por Sector";
$proto125=array();
$proto125["m_sql"] = "a.id_urna = u.id_urna";
...
$proto110["m_srcTableName"]="Alc - Por Sector";		
$obj = new SQLQuery($proto110);

$proto109["m_sql"] = "(select sum(a.nulos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
$proto109["m_srcTableName"] = "Alc - Por Sector";
$proto109["m_expr"]=$obj;
...
$proto128["m_strFieldList"] = "sum(a.utilizados)";
$proto128["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto134["m_sql"] = "sum(a.utilizados)";
$proto134["m_srcTableName"] = "Alc - Por Sector";
$proto134["m_expr"]=$obj;
$proto134["m_alias"] = "";
...
$proto137["m_link"] = "SQLL_MAIN";
			$proto138=array();
$proto138["m_strName"] = "voto_alcalde";
$proto138["m_srcTableName"] = "Alc - Por Sector";
...
$proto137["m_sql"] = "voto_alcalde as a";
$proto137["m_alias"] = "a";
...
$proto142["m_srcTableName"] = "Alc - Por Sector";
...
$proto141["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto141["m_alias"] = "u";
$proto141["m_srcTableName"] = "Alc - Por Sector";
$proto143=array();
$proto143["m_sql"] = "a.id_urna = u.id_urna";
...
$proto127["m_sql"] = "(select sum(a.utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
$proto127["m_srcTableName"] = "Alc - Por Sector";
$proto127["m_expr"]=$obj;
...
$proto146["m_strFieldList"] = "sum(a.no_utilizados)";
$proto146["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto152["m_sql"] = "sum(a.no_utilizados)";
$proto152["m_srcTableName"] = "Alc - Por Sector";
$proto152["m_expr"]=$obj;
$proto152["m_alias"] = "";
...
$proto155["m_link"] = "SQLL_MAIN";
			$proto156=array();
$proto156["m_strName"] = "voto_alcalde";
$proto156["m_srcTableName"] = "Alc - Por Sector";
...
$proto155["m_sql"] = "voto_alcalde as a";
$proto155["m_alias"] = "a";
$proto155["m_srcTableName"] = "Alc - Por Sector";
$proto157=array();
$proto157["m_sql"] = "";
...
$proto160["m_srcTableName"] = "Alc - Por Sector";
...
$proto159["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto159["m_alias"] = "u";
$proto159["m_srcTableName"] = "Alc - Por Sector";
$proto161=array();
$proto161["m_sql"] = "a.id_urna = u.id_urna";
...
$proto146["m_srcTableName"]="Alc - Por Sector";		
$obj = new SQLQuery($proto146);

$proto145["m_sql"] = "(select sum(a.no_utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
$proto145["m_srcTableName"] = "Alc - Por Sector";
$proto145["m_expr"]=$obj;
...
$proto164["m_strFieldList"] = "sum(a.total)";
$proto164["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto173["m_link"] = "SQLL_MAIN";
			$proto174=array();
$proto174["m_strName"] = "voto_alcalde";
...
$proto173["m_sql"] = "voto_alcalde as a";
$proto173["m_alias"] = "a";
$proto173["m_srcTableName"] = "Alc - Por Sector";
$proto175=array();
$proto175["m_sql"] = "";
...
$proto177["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto177["m_alias"] = "u";
$proto177["m_srcTableName"] = "Alc - Por Sector";
$proto179=array();
$proto179["m_sql"] = "a.id_urna = u.id_urna";
...
$proto163["m_sql"] = "(select sum(a.total) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
$proto163["m_srcTableName"] = "Alc - Por Sector";
$proto163["m_expr"]=$obj;
...
$proto181["m_link"] = "SQLL_MAIN";
			$proto182=array();
$proto182["m_strName"] = "voto_alcalde";
$proto182["m_srcTableName"] = "Alc - Por Sector";
...
$proto181["m_sql"] = "voto_alcalde as va";
$proto181["m_alias"] = "va";
$proto181["m_srcTableName"] = "Alc - Por Sector";
$proto183=array();
$proto183["m_sql"] = "";
...
$proto186["m_srcTableName"] = "Alc - Por Sector";
...
$proto185["m_sql"] = "inner join urna as ur on va.id_urna = ur.id_urna";
$proto185["m_alias"] = "ur";
$proto185["m_srcTableName"] = "Alc - Por Sector";
$proto187=array();
$proto187["m_sql"] = "va.id_urna = ur.id_urna";
...
$proto191["m_bAsc"] = 1;
$proto191["m_nColumn"] = 0;
$obj = new SQLOrderByItem($proto191);
