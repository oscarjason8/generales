...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsalc___por_urna["Spanish"]["Maria"] = "Maria Luisa Martell";
	$fieldToolTipsalc___por_urna["Spanish"]["Maria"] = "";
	$placeHoldersalc___por_urna["Spanish"]["Maria"] = "";
	$fieldLabelsalc___por_urna["Spanish"]["Victor"] = "Victor Rivera";
	$fieldToolTipsalc___por_urna["Spanish"]["Victor"] = "";
	$placeHoldersalc___por_urna["Spanish"]["Victor"] = "";
	$fieldLabelsalc___por_urna["Spanish"]["Adolfo"] = "Adolfo Canales";
	$fieldToolTipsalc___por_urna["Spanish"]["Adolfo"] = "";
	$placeHoldersalc___por_urna["Spanish"]["Adolfo"] = "";
...
$tdataalc___por_urna[".googleLikeFields"][] = "Maria";
$tdataalc___por_urna[".googleLikeFields"][] = "Victor";
$tdataalc___por_urna[".googleLikeFields"][] = "Adolfo";
...
$tdataalc___por_urna[".printerPageOrientation"] = 0;
$tdataalc___por_urna[".nPrinterPageScale"] = 100;

$tdataalc___por_urna[".nPrinterSplitRecords"] = 30;
...
$tdataalc___por_urna[".reportPrintGroupsPerPage"] = 30;
...
$tstrOrderBy = "order by ur.id_urna";
if(strlen($tstrOrderBy) && strtolower(substr($tstrOrderBy,0,8))!="order by")
	$tstrOrderBy = "order by ".$tstrOrderBy;
$tdataalc___por_urna[".strOrderBy"] = $tstrOrderBy;

$tdataalc___por_urna[".orderindexes"] = array();
	$tdataalc___por_urna[".orderindexes"][] = array(3, (1 ? "ASC" : "DESC"), "ur.id_urna");



$tdataalc___por_urna[".sqlHead"] = "select ur.id_distrito, ur.id_sector, ur.id_urna, ur.ubicación,  (select concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Maria,  (select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Victor,  (select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Adolfo,  (select sum(a.validos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Validos,  (select sum(a.blancos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Blancos,  (select sum(a.nulos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Nulos,  (select sum(a.utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Utilizados,  (select sum(a.no_utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as No_Utilizados,  (select sum(a.total) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Total";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "";
	$fdata["Label"] = GetFieldLabel("Alc___Por_Urna","Maria");
	$fdata["FieldType"] = 200;
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
//end of Filters settings
	...
	$tdataalc___por_urna["Maria"] = $fdata;
		$tdataalc___por_urna[".searchableFields"][] = "Maria";
//	Victor
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 6;
	...
	$fdata["ownerTable"] = "";
	$fdata["Label"] = GetFieldLabel("Alc___Por_Urna","Victor");
	$fdata["FieldType"] = 200;
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
//end of Filters settings
	...
	$tdataalc___por_urna["Victor"] = $fdata;
		$tdataalc___por_urna[".searchableFields"][] = "Victor";
//	Adolfo
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 7;
	...
	$fdata["ownerTable"] = "";
	$fdata["Label"] = GetFieldLabel("Alc___Por_Urna","Adolfo");
	$fdata["FieldType"] = 200;
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
//end of Filters settings
	...
	$tdataalc___por_urna["Adolfo"] = $fdata;
		$tdataalc___por_urna[".searchableFields"][] = "Adolfo";
//	Validos
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 8;
...
$proto0["m_strFieldList"] = "ur.id_distrito, ur.id_sector, ur.id_urna, ur.ubicación,  (select concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Maria,  (select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Victor,  (select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Adolfo,  (select sum(a.validos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Validos,  (select sum(a.blancos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Blancos,  (select sum(a.nulos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Nulos,  (select sum(a.utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Utilizados,  (select sum(a.no_utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as No_Utilizados,  (select sum(a.total) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Total";
$proto0["m_strFrom"] = "from voto_alcalde as va  inner join urna as ur on va.id_urna = ur.id_urna";
$proto0["m_strWhere"] = "";
$proto0["m_strOrderBy"] = "order by ur.id_urna";
...
$proto15["m_strFieldList"] = "concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto21["m_sql"] = "concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto14["m_sql"] = "(select concat(sum(a.candidato1), \" votos (\", ROUND((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
$proto14["m_srcTableName"] = "Alc - Por Urna";
$proto14["m_expr"]=$obj;
$proto14["m_alias"] = "Maria";
...
$proto36["m_strFieldList"] = "concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto42["m_sql"] = "concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto35["m_sql"] = "(select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
$proto35["m_srcTableName"] = "Alc - Por Urna";
$proto35["m_expr"]=$obj;
$proto35["m_alias"] = "Victor";
...
$proto57["m_strFieldList"] = "concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto63["m_sql"] = "concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")";
...
$proto56["m_sql"] = "(select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
$proto56["m_srcTableName"] = "Alc - Por Urna";
$proto56["m_expr"]=$obj;
$proto56["m_alias"] = "Adolfo";
...
$proto78["m_strFieldList"] = "sum(a.validos)";
...
$proto87["m_link"] = "SQLL_MAIN";
			$proto88=array();
$proto88["m_strName"] = "voto_alcalde";
$proto88["m_srcTableName"] = "Alc - Por Urna";
...
$proto87["m_table"] = $obj;
$proto87["m_sql"] = "voto_alcalde as a";
$proto87["m_alias"] = "a";
$proto87["m_srcTableName"] = "Alc - Por Urna";
$proto89=array();
$proto89["m_sql"] = "";
...
$proto92["m_srcTableName"] = "Alc - Por Urna";
...
$proto91["m_table"] = $obj;
$proto91["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto91["m_alias"] = "u";
$proto91["m_srcTableName"] = "Alc - Por Urna";
$proto93=array();
$proto93["m_sql"] = "a.id_urna = u.id_urna";
...
$proto77["m_sql"] = "(select sum(a.validos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto96["m_strFieldList"] = "sum(a.blancos)";
$proto96["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto102["m_sql"] = "sum(a.blancos)";
$proto102["m_srcTableName"] = "Alc - Por Urna";
$proto102["m_expr"]=$obj;
$proto102["m_alias"] = "";
...
$proto106["m_srcTableName"] = "Alc - Por Urna";
...
$proto110["m_srcTableName"] = "Alc - Por Urna";
...
$proto109["m_alias"] = "u";
$proto109["m_srcTableName"] = "Alc - Por Urna";
$proto111=array();
...
$proto96["m_srcTableName"]="Alc - Por Urna";		
$obj = new SQLQuery($proto96);

$proto95["m_sql"] = "(select sum(a.blancos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto114["m_strFieldList"] = "sum(a.nulos)";
...
$proto123["m_link"] = "SQLL_MAIN";
			$proto124=array();
$proto124["m_strName"] = "voto_alcalde";
$proto124["m_srcTableName"] = "Alc - Por Urna";
...
$proto123["m_sql"] = "voto_alcalde as a";
$proto123["m_alias"] = "a";
$proto123["m_srcTableName"] = "Alc - Por Urna";
$proto125=array();
$proto125["m_sql"] = "";
...
$proto128["m_srcTableName"] = "Alc - Por Urna";
...
$proto127["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto127["m_alias"] = "u";
$proto127["m_srcTableName"] = "Alc - Por Urna";
$proto129=array();
$proto129["m_sql"] = "a.id_urna = u.id_urna";
...
$proto114["m_srcTableName"]="Alc - Por Urna";		
$obj = new SQLQuery($proto114);

$proto113["m_sql"] = "(select sum(a.nulos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
$proto113["m_srcTableName"] = "Alc - Por Urna";
$proto113["m_expr"]=$obj;
...
$proto132["m_strFieldList"] = "sum(a.utilizados)";
$proto132["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto138["m_sql"] = "sum(a.utilizados)";
$proto138["m_srcTableName"] = "Alc - Por Urna";
$proto138["m_expr"]=$obj;
$proto138["m_alias"] = "";
...
$proto141["m_link"] = "SQLL_MAIN";
			$proto142=array();
$proto142["m_strName"] = "voto_alcalde";
$proto142["m_srcTableName"] = "Alc - Por Urna";
...
$proto141["m_sql"] = "voto_alcalde as a";
$proto141["m_alias"] = "a";
...
$proto146["m_srcTableName"] = "Alc - Por Urna";
...
$proto145["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto145["m_alias"] = "u";
$proto145["m_srcTableName"] = "Alc - Por Urna";
$proto147=array();
$proto147["m_sql"] = "a.id_urna = u.id_urna";
...
$proto131["m_sql"] = "(select sum(a.utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
$proto131["m_srcTableName"] = "Alc - Por Urna";
$proto131["m_expr"]=$obj;
...
$proto150["m_strFieldList"] = "sum(a.no_utilizados)";
$proto150["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto156["m_sql"] = "sum(a.no_utilizados)";
$proto156["m_srcTableName"] = "Alc - Por Urna";
$proto156["m_expr"]=$obj;
$proto156["m_alias"] = "";
...
$proto159["m_link"] = "SQLL_MAIN";
			$proto160=array();
$proto160["m_strName"] = "voto_alcalde";
$proto160["m_srcTableName"] = "Alc - Por Urna";
...
$proto159["m_sql"] = "voto_alcalde as a";
$proto159["m_alias"] = "a";
$proto159["m_srcTableName"] = "Alc - Por Urna";
$proto161=array();
$proto161["m_sql"] = "";
...
$proto164["m_srcTableName"] = "Alc - Por Urna";
...
$proto163["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto163["m_alias"] = "u";
$proto163["m_srcTableName"] = "Alc - Por Urna";
$proto165=array();
$proto165["m_sql"] = "a.id_urna = u.id_urna";
...
$proto150["m_srcTableName"]="Alc - Por Urna";		
$obj = new SQLQuery($proto150);

$proto149["m_sql"] = "(select sum(a.no_utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
$proto149["m_srcTableName"] = "Alc - Por Urna";
$proto149["m_expr"]=$obj;
...
$proto168["m_strFieldList"] = "sum(a.total)";
$proto168["m_strFrom"] = "from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna";
...
$proto177["m_link"] = "SQLL_MAIN";
			$proto178=array();
$proto178["m_strName"] = "voto_alcalde";
...
$proto177["m_sql"] = "voto_alcalde as a";
$proto177["m_alias"] = "a";
$proto177["m_srcTableName"] = "Alc - Por Urna";
$proto179=array();
$proto179["m_sql"] = "";
...
$proto181["m_sql"] = "inner join urna as u on a.id_urna = u.id_urna";
$proto181["m_alias"] = "u";
$proto181["m_srcTableName"] = "Alc - Por Urna";
$proto183=array();
$proto183["m_sql"] = "a.id_urna = u.id_urna";
...
$proto167["m_sql"] = "(select sum(a.total) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
$proto167["m_srcTableName"] = "Alc - Por Urna";
$proto167["m_expr"]=$obj;
...
$proto185["m_link"] = "SQLL_MAIN";
			$proto186=array();
$proto186["m_strName"] = "voto_alcalde";
$proto186["m_srcTableName"] = "Alc - Por Urna";
...
$proto185["m_sql"] = "voto_alcalde as va";
$proto185["m_alias"] = "va";
$proto185["m_srcTableName"] = "Alc - Por Urna";
$proto187=array();
$proto187["m_sql"] = "";
...
$proto190["m_srcTableName"] = "Alc - Por Urna";
...
$proto189["m_sql"] = "inner join urna as ur on va.id_urna = ur.id_urna";
$proto189["m_alias"] = "ur";
$proto189["m_srcTableName"] = "Alc - Por Urna";
$proto191=array();
$proto191["m_sql"] = "va.id_urna = ur.id_urna";
