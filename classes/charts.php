...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("distritos" == $this->chrt_array['tables'][0])
			return true;
		if("sectores" == $this->chrt_array['tables'][0])
			return true;
		if("urna" == $this->chrt_array['tables'][0])
			return true;
		if("voto_alcalde" == $this->chrt_array['tables'][0])
			return true;
		if("voto_diputado" == $this->chrt_array['tables'][0])
			return true;
		if("voto_presidente" == $this->chrt_array['tables'][0])
			return true;
		...
		if("voto_alcalde" == $this->chrt_array['tables'][0])
			return true;
		if("corporacion" == $this->chrt_array['tables'][0])
			return true;
		if("candidatos" == $this->chrt_array['tables'][0])
			return true;
		if("vdiputados" == $this->chrt_array['tables'][0])
			return true;
		if("vdiputados" == $this->chrt_array['tables'][0])
			return true;
		...
		if("urna" == $this->chrt_array['tables'][0])
			return true;
		if("partido" == $this->chrt_array['tables'][0])
			return true;
		if("corporaciones" == $this->chrt_array['tables'][0])
			return true;
