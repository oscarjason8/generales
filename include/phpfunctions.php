...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="voto_alcalde" && $field=="usuario")
	{
		return $_SESSION["UserID"];
	}
				if($table=="voto_alcalde" && $field=="fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="voto_diputado" && $field=="usuario")
	{
		return $_SESSION["UserID"];
	}
				if($table=="voto_diputado" && $field=="fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="voto_presidente" && $field=="usuario")
	{
		return $_SESSION["UserID"];
				...
				if($table=="voto_presidente" && $field=="fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="Alcalde_Chart" && $field=="usuario")
	{
		return $_SESSION["UserID"];
	}
				if($table=="Alcalde_Chart" && $field=="fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="Presidente_Chart" && $field=="usuario")
	{
		return $_SESSION["UserID"];
	}
...
function GetAutoUpdateValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="voto_alcalde" && $field=="editado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="voto_alcalde" && $field=="fecha_edicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="voto_diputado" && $field=="editado_por")
	{
		return $_SESSION["UserID"];
	}
				if($table=="voto_diputado" && $field=="fecha_edicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="voto_presidente" && $field=="editado_por")
	{
		return $_SESSION["UserID"];
	}
