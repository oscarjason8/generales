...
$tdataalc___por_urna[".nPrinterSplitRecords"] = 20;
...
$tdataalc___por_urna[".reportPrintGroupsPerPage"] = 20;
...
$tdataalc___por_urna[".sqlHead"] = "select ur.id_distrito, ur.id_sector, ur.id_urna, ur.ubicación,  (select concat(sum(a.candidato1), \" votos (\", ROUND(((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)) ))))*100),1), \"%)\")    from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as PAC,  (select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as FAPER,  (select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as NUEVA_RUTA,  (select concat(sum(a.candidato4), \" votos (\", ROUND((((sum(a.candidato4)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as ALIANZA_PAT,  (select concat(sum(a.candidato5), \" votos (\", ROUND((((sum(a.candidato5)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as LIBRE,  (select concat(sum(a.candidato6), \" votos (\", ROUND((((sum(a.candidato6)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as PSH,  (select concat(sum(a.candidato7), \" votos (\", ROUND((((sum(a.candidato7)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as LIDEHR,  (select concat(sum(a.candidato8), \" votos (\", ROUND((((sum(a.candidato8)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as DC,  (select concat(sum(a.candidato9), \" votos (\", ROUND((((sum(a.candidato9)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as TSH,  (select concat(sum(a.candidato10), \" votos (\", ROUND((((sum(a.candidato10)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as LIBERAL,  (select concat(sum(a.candidato11), \" votos (\", ROUND((((sum(a.candidato11)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as NACIONAL,  (select concat(sum(a.candidato12), \" votos (\", ROUND((((sum(a.candidato12)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as PINU,  (select concat(((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8))   + (sum(a.candidato9)) + (sum(a.candidato12))), \" votos (\", ROUND((((((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) +  (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato12))) / ((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Otros,  (select sum(a.validos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Validos,  (select sum(a.blancos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Blancos,  (select sum(a.nulos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Nulos,  (select sum(a.utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Utilizados,  (select sum(a.no_utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as No_Utilizados,  (select sum(a.total) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Total";
...
$proto0["m_strFieldList"] = "ur.id_distrito, ur.id_sector, ur.id_urna, ur.ubicación,  (select concat(sum(a.candidato1), \" votos (\", ROUND(((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)) ))))*100),1), \"%)\")    from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as PAC,  (select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as FAPER,  (select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as NUEVA_RUTA,  (select concat(sum(a.candidato4), \" votos (\", ROUND((((sum(a.candidato4)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as ALIANZA_PAT,  (select concat(sum(a.candidato5), \" votos (\", ROUND((((sum(a.candidato5)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as LIBRE,  (select concat(sum(a.candidato6), \" votos (\", ROUND((((sum(a.candidato6)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as PSH,  (select concat(sum(a.candidato7), \" votos (\", ROUND((((sum(a.candidato7)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as LIDEHR,  (select concat(sum(a.candidato8), \" votos (\", ROUND((((sum(a.candidato8)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as DC,  (select concat(sum(a.candidato9), \" votos (\", ROUND((((sum(a.candidato9)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as TSH,  (select concat(sum(a.candidato10), \" votos (\", ROUND((((sum(a.candidato10)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as LIBERAL,  (select concat(sum(a.candidato11), \" votos (\", ROUND((((sum(a.candidato11)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as NACIONAL,  (select concat(sum(a.candidato12), \" votos (\", ROUND((((sum(a.candidato12)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as PINU,  (select concat(((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8))   + (sum(a.candidato9)) + (sum(a.candidato12))), \" votos (\", ROUND((((((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) +  (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato12))) / ((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Otros,  (select sum(a.validos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Validos,  (select sum(a.blancos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Blancos,  (select sum(a.nulos) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Nulos,  (select sum(a.utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Utilizados,  (select sum(a.no_utilizados) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as No_Utilizados,  (select sum(a.total) from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna) as Total";
...
$proto15["m_strFieldList"] = "concat(sum(a.candidato1), \" votos (\", ROUND(((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)) ))))*100),1), \"%)\")";
...
$proto21["m_sql"] = "concat(sum(a.candidato1), \" votos (\", ROUND(((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)) ))))*100),1), \"%)\")";
...
$proto14["m_sql"] = "(select concat(sum(a.candidato1), \" votos (\", ROUND(((((sum(a.candidato1)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)) ))))*100),1), \"%)\")    from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto36["m_strFieldList"] = "concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto42["m_sql"] = "concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto35["m_sql"] = "(select concat(sum(a.candidato2), \" votos (\", ROUND((((sum(a.candidato2)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto57["m_strFieldList"] = "concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto63["m_sql"] = "concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto56["m_sql"] = "(select concat(sum(a.candidato3), \" votos (\", ROUND((((sum(a.candidato3)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto78["m_strFieldList"] = "concat(sum(a.candidato4), \" votos (\", ROUND((((sum(a.candidato4)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto84["m_sql"] = "concat(sum(a.candidato4), \" votos (\", ROUND((((sum(a.candidato4)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto77["m_sql"] = "(select concat(sum(a.candidato4), \" votos (\", ROUND((((sum(a.candidato4)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto99["m_strFieldList"] = "concat(sum(a.candidato5), \" votos (\", ROUND((((sum(a.candidato5)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto105["m_sql"] = "concat(sum(a.candidato5), \" votos (\", ROUND((((sum(a.candidato5)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto98["m_sql"] = "(select concat(sum(a.candidato5), \" votos (\", ROUND((((sum(a.candidato5)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto120["m_strFieldList"] = "concat(sum(a.candidato6), \" votos (\", ROUND((((sum(a.candidato6)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto126["m_sql"] = "concat(sum(a.candidato6), \" votos (\", ROUND((((sum(a.candidato6)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto119["m_sql"] = "(select concat(sum(a.candidato6), \" votos (\", ROUND((((sum(a.candidato6)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto141["m_strFieldList"] = "concat(sum(a.candidato7), \" votos (\", ROUND((((sum(a.candidato7)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto147["m_sql"] = "concat(sum(a.candidato7), \" votos (\", ROUND((((sum(a.candidato7)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto140["m_sql"] = "(select concat(sum(a.candidato7), \" votos (\", ROUND((((sum(a.candidato7)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto162["m_strFieldList"] = "concat(sum(a.candidato8), \" votos (\", ROUND((((sum(a.candidato8)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto168["m_sql"] = "concat(sum(a.candidato8), \" votos (\", ROUND((((sum(a.candidato8)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto161["m_sql"] = "(select concat(sum(a.candidato8), \" votos (\", ROUND((((sum(a.candidato8)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto183["m_strFieldList"] = "concat(sum(a.candidato9), \" votos (\", ROUND((((sum(a.candidato9)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto189["m_sql"] = "concat(sum(a.candidato9), \" votos (\", ROUND((((sum(a.candidato9)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto182["m_sql"] = "(select concat(sum(a.candidato9), \" votos (\", ROUND((((sum(a.candidato9)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto204["m_strFieldList"] = "concat(sum(a.candidato10), \" votos (\", ROUND((((sum(a.candidato10)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto210["m_sql"] = "concat(sum(a.candidato10), \" votos (\", ROUND((((sum(a.candidato10)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto225["m_strFieldList"] = "concat(sum(a.candidato11), \" votos (\", ROUND((((sum(a.candidato11)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto231["m_sql"] = "concat(sum(a.candidato11), \" votos (\", ROUND((((sum(a.candidato11)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto246["m_strFieldList"] = "concat(sum(a.candidato12), \" votos (\", ROUND((((sum(a.candidato12)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto252["m_sql"] = "concat(sum(a.candidato12), \" votos (\", ROUND((((sum(a.candidato12)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto245["m_sql"] = "(select concat(sum(a.candidato12), \" votos (\", ROUND((((sum(a.candidato12)/((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
...
$proto267["m_strFieldList"] = "concat(((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8))   + (sum(a.candidato9)) + (sum(a.candidato12))), \" votos (\", ROUND((((((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) +  (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato12))) / ((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto273["m_sql"] = "concat(((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8))   + (sum(a.candidato9)) + (sum(a.candidato12))), \" votos (\", ROUND((((((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) +  (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato12))) / ((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")";
...
$proto266["m_sql"] = "(select concat(((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8))   + (sum(a.candidato9)) + (sum(a.candidato12))), \" votos (\", ROUND((((((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) +  (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato12))) / ((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4))   + (sum(a.candidato5)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato10)) + (sum(a.candidato11))   + (sum(a.candidato12)))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_urna = ur.id_urna)";
