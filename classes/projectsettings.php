...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("usuario", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "distritos" ] = array( "url" => "distritos", "type" => 0 );
	$projectEntitiesReverse[ "distritos" ] = "distritos";
	$projectEntities[ "sectores" ] = array( "url" => "sectores", "type" => 0 );
	$projectEntitiesReverse[ "sectores" ] = "sectores";
	$projectEntities[ "urna" ] = array( "url" => "urna", "type" => 0 );
	$projectEntitiesReverse[ "urna" ] = "urna";
	$projectEntities[ "voto_alcalde" ] = array( "url" => "voto_alcalde", "type" => 0 );
	$projectEntitiesReverse[ "voto_alcalde" ] = "voto_alcalde";
	$projectEntities[ "voto_diputado" ] = array( "url" => "voto_diputado", "type" => 0 );
	$projectEntitiesReverse[ "voto_diputado" ] = "voto_diputado";
	$projectEntities[ "voto_presidente" ] = array( "url" => "voto_presidente", "type" => 0 );
	$projectEntitiesReverse[ "voto_presidente" ] = "voto_presidente";
	$projectEntities[ "usuario" ] = array( "url" => "usuario", "type" => 0 );
	$projectEntitiesReverse[ "usuario" ] = "usuario";
	$projectEntities[ "Alcalde_Chart" ] = array( "url" => "alcalde_chart", "type" => 3 );
	$projectEntitiesReverse[ "alcalde_chart" ] = "Alcalde_Chart";
	$projectEntities[ "Presidente_Chart" ] = array( "url" => "presidente_chart", "type" => 3 );
	$projectEntitiesReverse[ "presidente_chart" ] = "Presidente_Chart";
	$projectEntities[ "Pres - Por Distrito" ] = array( "url" => "pres___por_distrito", "type" => 2 );
	$projectEntitiesReverse[ "pres___por_distrito" ] = "Pres - Por Distrito";
	$projectEntities[ "Pres - Por Sector" ] = array( "url" => "pres___por_sector", "type" => 2 );
	$projectEntitiesReverse[ "pres___por_sector" ] = "Pres - Por Sector";
	$projectEntities[ "Pres - Por Urna" ] = array( "url" => "pres___por_urna", "type" => 2 );
	$projectEntitiesReverse[ "pres___por_urna" ] = "Pres - Por Urna";
	$projectEntities[ "Alc - Por Distrito" ] = array( "url" => "alc___por_distrito", "type" => 2 );
	$projectEntitiesReverse[ "alc___por_distrito" ] = "Alc - Por Distrito";
	$projectEntities[ "Alc - Por Sector" ] = array( "url" => "alc___por_sector", "type" => 2 );
	$projectEntitiesReverse[ "alc___por_sector" ] = "Alc - Por Sector";
	$projectEntities[ "Alc - Por Urna" ] = array( "url" => "alc___por_urna", "type" => 2 );
	$projectEntitiesReverse[ "alc___por_urna" ] = "Alc - Por Urna";
	$projectEntities[ "corporacion" ] = array( "url" => "corporacion", "type" => 0 );
	$projectEntitiesReverse[ "corporacion" ] = "corporacion";
	$projectEntities[ "candidatos" ] = array( "url" => "candidatos", "type" => 0 );
	$projectEntitiesReverse[ "candidatos" ] = "candidatos";
	$projectEntities[ "Dip - Por Orden" ] = array( "url" => "dip___por_orden", "type" => 2 );
	$projectEntitiesReverse[ "dip___por_orden" ] = "Dip - Por Orden";
	$projectEntities[ "Dip - Resultado Final" ] = array( "url" => "dip___resultado_final", "type" => 2 );
	$projectEntitiesReverse[ "dip___resultado_final" ] = "Dip - Resultado Final";
	$projectEntities[ "Dashboard" ] = array( "url" => "dashboard", "type" => 4 );
	$projectEntitiesReverse[ "dashboard" ] = "Dashboard";
	$projectEntities[ "Urnas - Pendientes" ] = array( "url" => "urnas___pendientes", "type" => 2 );
	$projectEntitiesReverse[ "urnas___pendientes" ] = "Urnas - Pendientes";
	$projectEntities[ "Urnas - Completadas" ] = array( "url" => "urnas___completadas", "type" => 2 );
	$projectEntitiesReverse[ "urnas___completadas" ] = "Urnas - Completadas";
	$projectEntities[ "partido" ] = array( "url" => "partido", "type" => 0 );
	$projectEntitiesReverse[ "partido" ] = "partido";
	$projectEntities[ "corporaciones" ] = array( "url" => "corporaciones", "type" => 0 );
	...
	$projectEntities[ "actas" ] = array( "url" => "actas", "type" => 0 );
	$projectEntitiesReverse[ "actas" ] = "actas";
}
